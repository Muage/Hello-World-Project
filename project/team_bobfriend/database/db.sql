...
/*메뉴 테이블*/
/* 본인 가게의 메뉴만 read하기 위해 m_code 추가됨 */
drop table tbl_menu;
...
alter table tbl_user modify column u_pass varchar(255) not null;
...
/* 신고 테이블 */
/* tbl_review의 r_date와 컬럼명 중복으로 report_date로 수정 */
...
/* 리뷰 테이블 */
/* tbl_report의 r_date와 컬럼명 중복으로 review_date로 수정 */
...
/*delete 가게,유저,삭제 where select DATEDIFF('2022-12-25','2022-12-01') >=14 and boolean true;*/
